...
$$e_ss = \lim_{s \to 0} \left s*E(s)$$

Con $E(s)$ siendo la transformada de la funcion de error

## Constante de error estatico y tipo de sistema

-Constante de posicion $K_p = \lim_{s \to 0} \left G(s)$
- Constante de Velocidad $K_p = \lim_{s \to 0} \left s*G(s)$
- Constante de Aceleracion $K_p = \lim_{s \to 0} \left s^2*G(s)$
